...
Rules:
- Use the UID provided by the user
...
# showed inline citations for each url, start and end, look into for future reference like rag and cag systems
# you use this for real time searches not when using preview, when you use preview the model generates the url from it's training knowledge
...
# final usage LLM prompt through AzureOpenAI for multithreader Azure endpoint
# what changed : candidate_key and formatting?, a few words here and there
...
#             "role": "user",
#             "content":"""
# Return only a list of direct and extended family members of elected political candidate "NAME" who are involved in politics, The details of "NAME" are added below as context.
# Context:
# UID:
# State Name:
# Election Name:
